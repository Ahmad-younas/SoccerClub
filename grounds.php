...
<head>
    ...
    <link href="css/ground.css" rel="stylesheet">
...
<body>
    <div class="ec-main-wrapper">
        ...
        <div class="row" style="display:flex; justify-content:center; padding-top:50px ">
            <div class="col-12">
                    <h1>You can Book your Ground for your matches</h1>
            </div>
        </div>
        ...
        <div class="ec-main-content">
            ...
            <figure>
            <a href="#"><img src="extra-images/blog-mediumtwo-1.jpg" alt=""></a>
            </figure>
            <div class="ec-blog-text">
            <ul class="ec-blog-option">
            <li> <a href="#" class="ec-colorhover">Alexander Protikhin</a></li>
            </ul>
            <h2><a href="#">Stamford Bridge contact information</a></h2>
            <p>Africa has some of the most incredible soccer teams (referre to as “football” for. Lorem ipsum dolor sit amet, consectetur adipiscing elit quis nostrud exercitation ullamco laboris nisi ut..</p>
            </div>
            </div>
            </li>
            <li class="col-md-12"style="list-style: none;">
            <div class="ec-blog-wrap">
            <figure>
            <a href="#"><img src="extra-images/blog-mediumtwo-2.jpg" alt=""></a>
            </figure>
            <div class="ec-blog-text">
            <ul class="ec-blog-option">
            <li> <a href="#" class="ec-colorhover">Jonathan Yurek</a></li>
            </ul>
            ...
            <div class="ec-blog-wrap">
            <figure>
            <a href="#"><img src="extra-images/blog-mediumtwo-3.jpg" alt=""></a>
            </figure>
            <div class="ec-blog-text">
            <ul class="ec-blog-option">
            <li> <a href="#" class="ec-colorhover">Dino Henderson</a></li>
            </ul>
            ...
            <div class="ec-blog-wrap">
            <figure>
            <a href="#"><img src="extra-images/blog-mediumtwo-4.jpg" alt=""></a>
            </figure>
            <div class="ec-blog-text">
            <ul class="ec-blog-option">
            <li> <a href="#" class="ec-colorhover">Alexander Protikhin</a></li>
            ...
            <div class="ec-blog-wrap">
            <figure>
            <a href="#"><img src="extra-images/blog-mediumtwo-5.jpg" alt=""></a>
            </figure>
            <div class="ec-blog-text">
            <ul class="ec-blog-option">
            <li> <a href="#" class="ec-colorhover">Jonathan Yurek</a></li>
