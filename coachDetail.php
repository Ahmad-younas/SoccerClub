...
<body>
    <div class="ec-main-wrapper">
        ...
        <h2>Michael Adem</h2> </div>
        <div class="ec-plyer-information">
        <figure>
        <a href="#"><img src="extra-images/ply1.jpg" alt=""></a>
        </figure>
            <div class="ec-plyer-designation">
                <ul>
                    <li><small>Birthdate</small> <span>May 22, 1991</span></li>
                    <li><small>POSITION</small> <span>Striker</span></li>
                    <li><small>GOALs</small> <span>40</span></li>
                    <li><small>YELLOW CARDS</small> <span>10</span></li>
                    <li><small>RED CARDS</small> <span>4</span></li>
                    <li><small>NATIONALITY</small> <span>Asian</span></li>
                    <li><small>HEIGHT</small> <span>1.01 M</span></li>
                    <li><small>WEIGHT</small> <span>60 KG</span></li>
                    <li><small>Nicknames</small> <span>Nole</span></li>
                </ul>
            </div>
        </div>
        <div class="ec-fancy-title">
        <h2>Plyer DESCRIPTION</h2> </div>
        <div class="ec-detail-editor ec-plyer-information-wrap">
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae, illum similique. Accusantium, beatae laudantium? Illo voluptas excepturi et in expedita doloribus delectus culpa error soluta iste, alias modi voluptate dolor.</p>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae, illum similique. Accusantium, beatae laudantium? Illo voluptas excepturi et in expedita doloribus delectus culpa error soluta iste, alias modi voluptate dolor.</p>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae, illum similique. Accusantium, beatae laudantium? Illo voluptas excepturi et in expedita doloribus delectus culpa error soluta iste, alias modi voluptate dolor.</p>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quae, illum similique. Accusantium, beatae laudantium? Illo voluptas excepturi et in expedita doloribus delectus culpa error soluta iste, alias modi voluptate dolor.</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <aside class="widget col-md-4 widget_categories">
                        ...
                        <h2>CATEGORY</h2></div>
                        <ul>
                        <li style="list-style: none;"><a href="#">Coaches</a></li>
                        <li style="list-style: none;"><a href="#">Grounds</a></li>
                        <li style="list-style: none;"><a href="#">Players</a></li>
                        <li style="list-style: none;"><a href="#">Match Details</a></li>
                        <li style="list-style: none;"><a href="#">Weather</a> 02</li>
                        <li style="list-style: none;"><a href="#">Match Statistics</a> 11</li>
                        </ul>
                        </aside>
